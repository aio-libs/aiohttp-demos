def setup_routes(app, handler, project_root):
    ...
    router.add_post('/logout', h.logout, name='logout')
    ...
    router.add_post('/{username}/follow', h.follow_user, name='follow_user')
    router.add_post('/{username}/unfollow', h.unfollow_user,
                    name='unfollow_user')
